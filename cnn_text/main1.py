...
def sst(text_field, label_field,  **kargs):
    ...
    #print(train_data)
    #text_build.build_vocab(train, vectors=GloVe(name='6B', dim=300))
    text_field.build_vocab(train_data, dev_data, test_data,vectors=vec1)
...
# load data
print("\nLoading data...")
text_field = data.Field(lower=True,tokenize=tokenizer,use_vocab=True, batch_first=False)
